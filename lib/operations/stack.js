    ...
    (getStackFrameName = (function() {
        {
            ...
            return (function(frame) {
                var frame = frame,
                    func = frame["func"];
                return (!func ? global : compute.branch(object.hasProperty(func, "name"), logicalOr(
                    compute.bind(object.get(func, "name"), toString), anon), anon));
            });
        }
    })());
    (exports.stack = stack);

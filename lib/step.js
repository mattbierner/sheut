 ...
 * DO NOT EDIT
*/
define(["require", "exports", "atum/compute", "atum/compute/tail", "atum/debug/debuggable", "sheut/state"], (function(require, exports, compute, __o, debuggable, __o0) {
    "use strict";
    ...
    var compute = compute,
        ...
        Debugger = __o0["Debugger"]; {
            ...
            var abrupt = or(not(debuggerDgr), not(breakpoint));
            (next = (function() {
                {
                    var next = (function(s) {
            ...
            (run = nextWhile.bind(null, all(notComplete, not(debuggerDgr), not(breakpoint))));

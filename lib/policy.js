 ...
 * DO NOT EDIT
*/
define(["require", "exports", "sheut/semantics/debug/debuggable", "sheut/fun", "sheut/run", "sheut/operations/context"], (
        ...
        var binary = (function(f) {
            return (function(a, b) {
                return (function(current, next, previous) {
                    return f(a(current, next, previous), b(current, next, previous));
                });
            });
        });

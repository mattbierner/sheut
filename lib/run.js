 ...
 * DO NOT EDIT
*/
define(["require", "exports", "atum/compute/statement", "atum/compute/program", "sheut/debug", "sheut/state"], (function(require, exports, statement, program, __o, __o0) {
    "use strict";
    ...
    (executeContext = (function(dctx, p, ok, err) {
        return (function() {
            {
                var result = finish(debug(program.liftStatement(statement.liftExpression(p)), dctx.ctx, (function(x, ctx) {
                    return (function(d) {
                        return ok(x, ctx, d);
                    });
                }), (function(x, ctx) {

        ...
        operations = operations; {
            ...
            (createUnconditional = (function(id, line) {
                return Breakpoint.create(id, (function(current, next) {
                    return operations.execute(current, operations.location, (function(currentLocation) {
                        return operations.execute(next, operations.location, (function(nextLocation) {
                ...
                return (function() {
                    {
                        var condition = program.bind(prog, (function(f, g) {
                            ...
                            return Breakpoint.create(id, (function(_, next) {
                                return operations.execute(next, condition, (function(result) {
                                    return result;
                                }), (function(_) {
                                    return false;
                                }));

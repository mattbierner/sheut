 ...
 * DO NOT EDIT
*/
define(["require", "exports", "amulet/record", "atum/compute", "atum/debug/debuggable", "atum/operations/type_conversion", "sheut/operations"], (function(require, exports, record, __o, debuggable, __o0, operations) {
    "use strict";
    ...
    var record = record,
        ...
        operations = operations; {
            ...
            (createConditional = (function(id, expression) {
                return Breakpoint.create(id, (function(d) {
                    return operations.executeContext(d, bind(expression, toBoolean), (function(result) {

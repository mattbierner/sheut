 ...
 * DO NOT EDIT
*/
define(["require", "exports", "sheut/semantics/debug/debuggable", "sheut/fun", "sheut/run", "sheut/operations/context"], (function(require, exports, debuggable, __o, __o0, context) {
    "use strict";
    var always, never, notComplete, not, and, or, all, any, breakpoint, depthGt, depthGte, depthEq, debuggerDgr, statementDgr, line, sameLine;
    ...
    (sameLine = (function(current, next) {
        return extract(current, context.location, false, (function(currentLocation) {
            return extract(next, context.location, false, (function(nextLocation) {
                return ((currentLocation && nextLocation) && containsLine(currentLocation, nextLocation.start.line));
            }));
        }));
    }));
